...
description: Common issues and solutions for Vue Solana setup, wallet connection, transaction signing, and Nuxt auto-imports.
tags:
  - troubleshooting
  - errors
  - wallet
...
For the `@solana/web3-compat` TypeScript metadata workaround, see [@solana/web3-compat TypeScript Workaround](../concepts/web3-compat.md).
