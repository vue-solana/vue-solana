...
- `security-and-hardening` - For broader secure coding and hardening guidance
- `security-scanning-security-requirement-extraction` - For deriving security requirements from threats
- `security-scanning-threat-mitigation-mapping` - For mapping threats to controls
