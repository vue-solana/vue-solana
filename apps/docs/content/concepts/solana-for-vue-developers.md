...
Frontend apps read Solana data through an RPC endpoint. `@vue-solana/core/web3` exposes the supported `Connection` class that sends requests to that endpoint.
