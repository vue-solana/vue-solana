---
title: Vue Vite 예제
description: @vue-solana/vue를 위한 실행 가능한 Vue 3 및 Vite 예제 앱입니다.
ogSection: 예제
surroundOrder: 17
---

Vue Vite 예제는 `@vue-solana/vue`를 위한 실행 가능한 Vue 3 앱입니다.

소스: <a href="https://github.com/vue-solana/vue-solana/tree/main/examples/vue-vite" target="_blank" rel="noopener noreferrer"><code>examples/vue-vite</code></a>
...
- `useTransaction()`으로 async transaction 상태를 추적합니다.
...
터미널에 출력되는 Vite URL을 엽니다. 보통 `http://localhost:5173`입니다.
