...
This document tracks the implementation plan for QR code scanning and Solana Pay support. It is separate from the roadmap because Solana Pay can ship independently of the stabilization work.
